...
import { WorkoutSetCard, SetStatus } from '@/components/workout/workout-set-card';
import { WorkoutProgress } from '@/components/workout/workout-progress';
import { RestTimer } from '@/components/workout/rest-timer';
import { RepInputModal } from '@/components/workout/rep-input-modal';
...
export default function WorkoutDayScreen() {
  ...
  const handleCompleteSet = () => {
    ...
    if (currentSet.isMinimum) {
      ...
      const reps = typeof currentSet.targetReps === 'number'
