...
import { getUserProgress, isWorkoutCompleted } from "@/utils/workout-storage";
import { getAvailableWeeks, getWorkoutSummary, capitalizeDayName, DayOfWeek } from "@/utils/workout-helpers";
          ...
          <View key={week} style={styles.weekCard}>
            ...
            >
              <View style={styles.weekHeaderContent}>
                <Text style={[styles.weekTitle, isCurrentWeek && styles.weekTitleCurrent]}>Week {week}</Text>
                {isCurrentWeek && <Text style={styles.currentBadge}>Current</Text>}
              </View>
